...
@section('content')
<div class="flex flex-col gap-space-xl" id="roleCreatePage">
    ...
    <div class="flex items-center gap-space-md">
        ...
        <div class="flex items-center gap-space-md">
            ...
            <div>
                ...
                <p class="font-body-sm text-body-sm text-secondary mt-space-2xs">Buat role baru dan tetapkan hak akses berdasarkan menu sidebar</p>
            </div>
        </div>
    </div>
            ...
            <div class="p-space-xl">
                ...
                <div class="mb-space-lg">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required
                        ...
                        placeholder="Masukkan nama role (contoh: Operator)">
                    @error('name')
