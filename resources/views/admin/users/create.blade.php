...
<div class="flex flex-col gap-space-xl">
    ...
    <div class="flex items-center gap-space-md">
        ...
        <div class="flex items-center gap-space-md">
            ...
            <div>
                <h1 class="font-headline-xl text-headline-xl text-on-surface font-bold tracking-tight">Tambah Pengguna Baru</h1>
                <p class="font-body-sm text-body-sm text-secondary mt-space-2xs">Isi informasi untuk membuat akun pengguna baru</p>
            </div>
        </div>
    </div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-space-lg lg:grid-cols-2">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="flex items-center gap-space-md">
                            <div id="avatar-preview" class="flex h-16 w-16 items-center justify-center rounded-full border-2 border-dashed border-surface-container-high bg-surface">
                            ...
                            <div>
                                ...
                                <p class="font-label-sm text-label-sm text-secondary mt-space-xs">Format: JPG, PNG, WEBP. Maks 2MB.</p>
                            </div>
                        </div>
                        @error('avatar')
                            <p class="text-xs text-red-500 mt-space-2xs">{{ $message }}</p>
