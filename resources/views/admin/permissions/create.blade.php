...
<div class="glass-card" style="max-width: 600px;">
    <form action="{{ route('admin.permissions.store') }}" method="POST">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="name" class="" style="width:100%; padding: 10px; border-radius: 8px; border: 1px solid var(--border-color); background: var(--bg-secondary); color: var(--text-primary);" required>
